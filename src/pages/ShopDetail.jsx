  ...
  return (
    <div className="bg-white min-h-screen pb-28 lg:pb-6">
          ...
          <div className="flex gap-2.5 mt-4">
            {shop.phone && (
              <a href={`tel:${shop.phone}`}
                className="flex-1 flex items-center justify-center gap-2 h-11 rounded-2xl text-sm font-bold border-2 border-gray-100 text-gray-700 hover:border-gray-200 hover:bg-gray-50 transition-all active:scale-95">
                <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
      ...
      <div className="lg:hidden fixed bottom-0 left-0 right-0 z-50 bg-white border-t border-gray-100 shadow-[0_-4px_20px_rgba(0,0,0,0.06)]"
        ...
        <div className="grid grid-cols-3 divide-x divide-gray-100 max-w-2xl mx-auto">
          {shop.phone ? (
            <a href={`tel:${shop.phone}`}
              className="flex flex-col items-center justify-center gap-0.5 py-3 text-xs font-semibold text-gray-600 hover:bg-gray-50 active:bg-gray-100 transition-colors">
