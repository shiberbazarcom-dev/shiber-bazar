    ...
    <div className="bg-white rounded-2xl border border-gray-100 p-3.5 hover:shadow-sm transition-shadow">
      <div className="flex items-center gap-3">
        {entry.photo_url
          ...
          : <span className="w-12 h-12 rounded-full bg-gray-100 text-gray-500 font-bold text-lg flex items-center justify-center flex-shrink-0">
              {(entry.full_name || '?')[0]}
            </span>
        }
      ...
      <div className="flex gap-2 mt-3">
        <a href={`tel:${entry.phone_number}`}
          className="flex-1 h-9 rounded-xl flex items-center justify-center gap-1.5 text-xs font-semibold text-purple-700 bg-purple-50 hover:bg-purple-100 active:scale-95 transition-all border border-purple-100">
        ...
        <a href={whatsappUrl(entry.phone_number, 'আসসালামু আলাইকুম, শিবের বাজার সেবা ডিরেক্টরি থেকে যোগাযোগ করছি।')}
          ...
          className="w-9 h-9 rounded-xl flex items-center justify-center text-green-600 bg-green-50 hover:bg-green-100 active:scale-95 transition-all border border-green-100 flex-shrink-0">
    ...
    <div className="bg-white min-h-screen">
      ...
      <div className="max-w-3xl mx-auto px-4 py-6 pb-24 md:pb-10">
        ...
        <Link to="/services/submit"
          className="mt-6 flex items-center justify-between gap-3 rounded-2xl border-2 border-dashed border-purple-200 bg-purple-50/50 p-4 hover:border-purple-300 hover:bg-purple-50 active:scale-[0.98] transition-all">
          <div>
