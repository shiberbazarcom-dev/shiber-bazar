    ...
    <div className="bg-white rounded-2xl border border-gray-100 p-3.5 hover:shadow-sm transition-shadow">
      ...
      <div className="flex gap-2 mt-3">
        <a href={`tel:${entry.phone_number}`}
          className="flex-1 h-9 rounded-xl flex items-center justify-center gap-1.5 text-xs font-semibold text-blue-700 bg-blue-50 hover:bg-blue-100 active:scale-95 transition-all border border-blue-100">
