        ...
        <div className="flex gap-2">
            ...
            {waNum && (
              <a
                ...
                onClick={stopProp}
                className="flex-1 flex items-center justify-center gap-1.5 px-3 py-2 border border-green-200 rounded-xl text-sm font-medium text-green-700 hover:bg-green-50 active:scale-95 transition-all"
              >
