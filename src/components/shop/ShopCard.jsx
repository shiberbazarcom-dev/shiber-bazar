  ...
  return (
    ...
    >
      ...
      <Link to={shopUrl} className="block relative flex-shrink-0">
        <div className="relative h-28 sm:h-40 overflow-hidden bg-gradient-to-br from-blue-600 to-blue-800">
          {coverUrl ? (
            <img
              src={coverUrl}
              alt={shop.shop_name}
      ...
      <div className="flex flex-col flex-1 p-3 sm:p-4 gap-2.5 sm:gap-3">
        ...
        {/* Logo + Name */}
        <Link to={shopUrl} className="flex items-center gap-2 sm:gap-3 group">
          <div className="w-10 h-10 sm:w-14 sm:h-14 rounded-full overflow-hidden border-2 border-white shadow-md ring-2 ring-blue-100 flex-shrink-0 bg-white">
            <img
              src={logoUrl}
              alt=""
              className="w-full h-full object-cover"
          ...
          <div className="flex-1 min-w-0">
            <div className="flex items-center gap-1.5 flex-wrap">
              <h3 className="font-bold text-gray-900 text-sm sm:text-[15px] leading-tight truncate group-hover:text-blue-600 transition-colors">
                {shop.shop_name}
              </h3>
              {shop.is_verified && (
        ...
        <div className="flex gap-2">
            ...
            {waNum && (
              <a
                ...
                onClick={stopProp}
                aria-label="WhatsApp"
                className="w-9 h-9 sm:w-auto sm:flex-1 sm:px-2 flex items-center justify-center gap-1 border border-green-200 rounded-xl text-xs font-bold text-green-700 hover:bg-green-50 active:scale-95 transition-all whitespace-nowrap flex-shrink-0"
              >
                <svg className="w-4 h-4 sm:w-3.5 sm:h-3.5 text-green-600 flex-shrink-0" fill="currentColor" viewBox="0 0 24 24">
        ...
        <Link
          to={shopUrl}
          className="mt-auto block w-full text-center bg-blue-600 hover:bg-blue-700 active:bg-blue-800 text-white font-semibold text-xs sm:text-sm py-2 sm:py-2.5 rounded-xl transition-colors"
        >
          দোকান দেখুন &rarr;
        </Link>
      </div>
