...
export default function ServiceCategoryCard({ category }) {
  ...
  return (
    <Link
      to={`/services/${slug}`}
      className="flex flex-col items-center justify-center gap-1.5 py-3 px-1 bg-white rounded-2xl border border-gray-100 shadow-sm hover:shadow-md hover:border-purple-200 active:scale-95 transition-all text-center group"
    >
