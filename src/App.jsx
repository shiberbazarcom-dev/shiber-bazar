...
function WhatsAppButton() {
  ...
  return (
    <a
      ...
      className="fixed md:bottom-6 right-4 md:right-6 z-50 flex items-center justify-center w-12 h-12 md:w-14 md:h-14 bg-green-500 rounded-full shadow-lg hover:bg-green-600 hover:scale-110 transition-all duration-300 group"
      style={{ bottom: '72px' }}
      aria-label="WhatsApp"
    >
