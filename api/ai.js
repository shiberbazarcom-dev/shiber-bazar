...
তুমি একজন বাংলাদেশী e-commerce কপিরাইটার। নিচের পণ্যের জন্য আকর্ষণীয় বিবরণ লেখো।
...
সম্পূর্ণ বাংলায় লেখো। JSON format এ return করো:
{
  "description": "৩-৫ বাক্যের আকর্ষণীয় বিবরণ",
  "seo_title": "SEO friendly শিরোনাম (৬০ অক্ষরের মধ্যে)",
...
তুমি "${shopName}" দোকানের একজন বিনয়ী customer service প্রতিনিধি।
Customer এর মেসেজের জন্য ৩টি আলাদা reply suggestion দাও।

Customer মেসেজ: "${customerMessage}"
${productList ? `দোকানের পণ্যসমূহ: ${productList}` : ''}

সম্পূর্ণ বাংলায় লেখো। JSON format এ return করো:
{
  "replies": [
    "রিপ্লাই ১ (সংক্ষিপ্ত, ১-২ বাক্য)",
    "রিপ্লাই ২ (মাঝারি, ২-৩ বাক্য, দাম/বিস্তারিত সহ)",
    "রিপ্লাই ৩ (বিস্তারিত, ৩-৪ বাক্য)"
  ]
}
